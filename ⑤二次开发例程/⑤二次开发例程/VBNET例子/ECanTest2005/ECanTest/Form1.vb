...
Public Class Form1
    ...
    Private Sub btnWrite_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnWrite.Click
        ...
        If ECAN.ECANDLL.Transmit(1, 0, 0, frameinfo, 1) = ECAN.ECANStatus.STATUS_OK Then
            IncludeTextMessage("Message was successfully SENT")
        Else
            IncludeTextMessage("Message was send Fault")
        End If
    ...
    Private Sub ReadMessages()
        ...
        While m_connect = 1 AndAlso stsResult = ECAN.ECANStatus.STATUS_OK

            mLen = 1
            stsResult = ECAN.ECANDLL.Receive(1, 0, 0, frameinfo, mLen, 200)

            ' A message was received
            ' We process the message(s)
            '
            If stsResult = ECAN.ECANStatus.STATUS_OK AndAlso mLen > 0 Then
                ...
                If lbxRec.Items.Count > 1000 Then
                    lbxRec.Items.Clear()
