...
struct RepeatBuilder {
  ...
  RepeatBuilder &operator=(const RepeatBuilder &);
...
struct MsgTestBuilder {
  ...
  MsgTestBuilder &operator=(const MsgTestBuilder &);
...
struct MsgRequestBuilder {
  ...
  MsgRequestBuilder &operator=(const MsgRequestBuilder &);
...
struct MsgResponseBuilder {
  ...
  MsgResponseBuilder &operator=(const MsgResponseBuilder &);
