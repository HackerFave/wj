...
//    P_testDataThread = new testDataThread(P_Serial);
//    P_Thread = new QThread;
//    P_testDataThread->moveToThread(P_Thread);

//    connect(P_Thread,SIGNAL(finished()),P_testDataThread,SLOT(deleteLater()));
//    connect(P_Thread,SIGNAL(started()),P_testDataThread,SLOT(slotWork()));
//    P_Thread->start();
//    P_testDataThread->startWork();

//    //线程池
//    _pool.setMaxThreadCount(5);
//    _threadMap[0] = new serialWorkThreadPool(0,P_Serial);
//    _threadMap[0]->startWork();
//    //    _threadMap[0]->signalStartWork();
//    _threadMap[1] = new serialWorkThreadPool_1(1,P_Serial);
//    _threadMap[1]->startWork();
//    //    _threadMap[1]->signalStartWork();
//    _threadMap[2] = new serialWorkThreadPool_2(2,P_Serial);
//    _threadMap[2]->startWork();
//    _threadMap[3] = new serialWorkThreadPool_3(3,P_Serial);
//    _threadMap[3]->startWork();
//    _threadMap[4] = new serialWorkThreadPool_4(4,P_Serial);
